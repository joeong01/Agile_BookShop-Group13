...
if ( $row->stockLevel < 20){ $lowStock +=1; } } $totalBook=count($totalStock); foreach($categories as $row) { $value[$x]=$row->book;
    $x++;
    }
