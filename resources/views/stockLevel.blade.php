            ...
            <form action="" method="GET">
                ...
                <div class="card shadow mt-3">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            <div>
                                <input type="checkbox" name="categories[]" value="<?= $booklist['categoryID']; ?>" <?php if (in_array($booklist['categoryID'], $checked)) {
                                                                                                                        echo "checked";
                                                                                                                    } ?> />
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <h6>ISBN</h6>
                        <input type="radio" name="type" value="book.ISBN_13 ASC" <?php if (!empty($_GET['type']) && $_GET['type'] == "book.ISBN_13 ASC") {
                                                                                        echo "checked";
                                                                                    } ?>> Ascending
                        <input type="radio" name="type" <?php if (!empty($_GET['type']) && $_GET['type'] == "book.ISBN_13 DESC") {
                                                            echo "checked";
                                                        } ?> value="book.ISBN_13 DESC"> Descending
                        <br><br>

                        <h6>Book Name</h6>
                        <input type="radio" name="type" <?php if (!empty($_GET['type']) && $_GET['type'] == "book.bookName ASC") {
                                                            echo "checked";
                                                        } ?> value="book.bookName ASC"> Ascending
                        <input type="radio" name="type" <?php if (!empty($_GET['type']) && $_GET['type'] == "book.bookName DESC") {
                                                            echo "checked";
                                                        } ?> value="book.bookName DESC"> Descending
                        <br><br>

                        <h6>Stock Level</h6>
                        <input type="radio" name="type" value="stock.stockLevel ASC" <?php if (!empty($_GET['type']) && $_GET['type'] == "stock.stockLevel ASC") {
                                                                                            echo "checked";
                                                                                        } ?>> Ascending
                        ...
                        <table>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a href="http://127.0.0.1:8000/delete_book?id={{ $proditems['ISBN_13'] }}"><img src="{{ url('/Picture/delete.png') }}" width="50px" height="50px"></a>
                                            <td>
                                        </tr>
                            <?php
                                    }
